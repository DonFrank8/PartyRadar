...
const I18N = {
  de: {
    hero_title: "Finde den Soundtrack deiner Nacht mit VIBEON.",
    hero_subtitle: "Music, Beach, Live Vibes und Lifestyle Hotspots - alles auf einer Karte.",
    hero_chip_fallback: "Live Musik entdecken",
    hero_chip_vibe: "Music, Beach, Live & Lifestyle",
    hero_search_label: "Suche",
    hero_search_placeholder: "Ort, Event oder Genre suchen",
    discover_title: "VIBES entdecken",
    discover_subtitle: "Filtere nach Suche, Stadt, Datum und Genres für deinen nächsten Moment.",
    filter_search: "Suche",
  ...
  en: {
    hero_title: "Find the soundtrack of your night with VIBEON.",
    hero_subtitle: "Music, beach, live vibes and lifestyle hotspots - all on one map.",
    ...
    discover_subtitle: "Filter by search, city, date and genres for your next moment.",
  ...
  es: {
    hero_title: "Encuentra la banda sonora de tu noche con VIBEON.",
    hero_subtitle: "Música, beach, live vibes y lifestyle hotspots - todo en un solo mapa.",
    ...
    discover_subtitle: "Filtra por búsqueda, ciudad, fecha y géneros para tu próximo plan.",
